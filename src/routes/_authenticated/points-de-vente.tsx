  ...
  return (
    <div>
      <PageHeader
        ...
        description={`${data.length} restaurants Ladid Food à Kénitra`}
        actions={<Button className="rounded-full bg-primary text-primary-foreground" onClick={() => toast.success("Ouvrir le formulaire de création")}><Plus className="h-4 w-4 mr-1" />Ajouter</Button>}
      />
